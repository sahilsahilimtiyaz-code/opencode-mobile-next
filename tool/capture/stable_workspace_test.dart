// Deterministic captures for the stable-workspace repair (2026-09-13): the
...
//
// Run: flutter test --concurrency=1 tool/capture/stable_workspace_test.dart
// Output: docs/qa/stable-workspace-2026-09-13/*.png
...
void main() {
  ...
  for (final light in [false, true]) {
    for (final scenario in _scenarios) {
      ...
      testWidgets('stable workspace $name', (tester) async {
        ...
        try {
          ...
          final largeText = scenario.scale * 14 > 18;
          ...
          if (!scenario.end) {
            _expectPaintedWhole(
              ...
              largeText
                  ...
                  : find.descendant(
                      of: header,
                      matching: find.text(scenario.name),
                    ),
          ...
          await writePng(
            'docs/qa/stable-workspace-2026-09-13/$name.png',
