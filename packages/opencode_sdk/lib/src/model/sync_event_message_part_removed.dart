...
part 'sync_event_message_part_removed.g.dart';
...
class SyncEventMessagePartRemoved {
  /// Returns a new [SyncEventMessagePartRemoved] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SyncEventMessagePartRemovedTypeEnum.unknownDefaultOpenApi,
  )
  final SyncEventMessagePartRemovedTypeEnum type;
  ...
  factory SyncEventMessagePartRemoved.fromJson(Map<String, dynamic> json) =>
      _$SyncEventMessagePartRemovedFromJson(json);

  Map<String, dynamic> toJson() => _$SyncEventMessagePartRemovedToJson(this);
...
enum SyncEventMessagePartRemovedTypeEnum {
  @JsonValue(r'sync')
  sync_(r'sync'),
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi(r'unknown_default_open_api');

  const SyncEventMessagePartRemovedTypeEnum(this.value);
