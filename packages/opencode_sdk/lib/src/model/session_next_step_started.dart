...
part 'session_next_step_started.g.dart';
...
class SessionNextStepStarted {
  /// Returns a new [SessionNextStepStarted] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionNextStepStartedTypeEnum.unknownDefaultOpenApi,
  )
  final SessionNextStepStartedTypeEnum type;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is SessionNextStepStarted &&
  ...
  factory SessionNextStepStarted.fromJson(Map<String, dynamic> json) =>
      _$SessionNextStepStartedFromJson(json);

  Map<String, dynamic> toJson() => _$SessionNextStepStartedToJson(this);
...
enum SessionNextStepStartedTypeEnum {
  ...
  const SessionNextStepStartedTypeEnum(this.value);
