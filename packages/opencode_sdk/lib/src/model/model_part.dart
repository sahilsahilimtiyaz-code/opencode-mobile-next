...
class ModelPart implements OpenCodeRawJsonValue {
  ModelPart(Object? value) : value = _copyJsonValue(value);

  factory ModelPart.fromJson(Object? json) => ModelPart(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"\$ref\":\"#/components/schemas/TextPart\"},{\"\$ref\":\"#/components/schemas/SubtaskPart\"},{\"\$ref\":\"#/components/schemas/ReasoningPart\"},{\"\$ref\":\"#/components/schemas/FilePart\"},{\"\$ref\":\"#/components/schemas/ToolPart\"},{\"\$ref\":\"#/components/schemas/StepStartPart\"},{\"\$ref\":\"#/components/schemas/StepFinishPart\"},{\"\$ref\":\"#/components/schemas/SnapshotPart\"},{\"\$ref\":\"#/components/schemas/PatchPart\"},{\"\$ref\":\"#/components/schemas/AgentPart\"},{\"\$ref\":\"#/components/schemas/RetryPart\"},{\"\$ref\":\"#/components/schemas/CompactionPart\"}]}";
