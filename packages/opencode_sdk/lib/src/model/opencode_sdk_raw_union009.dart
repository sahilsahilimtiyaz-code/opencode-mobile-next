...
class OpencodeSdkRawUnion009 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion009(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion009.fromJson(Object? json) =>
      OpencodeSdkRawUnion009(json);
