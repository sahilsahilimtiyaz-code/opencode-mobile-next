...
part 'session_next_text_started.g.dart';
...
class SessionNextTextStarted {
  /// Returns a new [SessionNextTextStarted] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionNextTextStartedTypeEnum.unknownDefaultOpenApi,
  )
  final SessionNextTextStartedTypeEnum type;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is SessionNextTextStarted &&
  ...
  factory SessionNextTextStarted.fromJson(Map<String, dynamic> json) =>
      _$SessionNextTextStartedFromJson(json);

  Map<String, dynamic> toJson() => _$SessionNextTextStartedToJson(this);
...
enum SessionNextTextStartedTypeEnum {
  ...
  const SessionNextTextStartedTypeEnum(this.value);
