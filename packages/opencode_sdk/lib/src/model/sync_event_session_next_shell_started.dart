...
part 'sync_event_session_next_shell_started.g.dart';
...
class SyncEventSessionNextShellStarted {
  /// Returns a new [SyncEventSessionNextShellStarted] instance.
  ...
  final SyncEventSessionNextShellStartedTypeEnum type;
  ...
  factory SyncEventSessionNextShellStarted.fromJson(
    Map<String, dynamic> json,
  ) => _$SyncEventSessionNextShellStartedFromJson(json);

  Map<String, dynamic> toJson() =>
      _$SyncEventSessionNextShellStartedToJson(this);
...
enum SyncEventSessionNextShellStartedTypeEnum {
  @JsonValue(r'sync')
  sync_(r'sync'),
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi(r'unknown_default_open_api');

  const SyncEventSessionNextShellStartedTypeEnum(this.value);
