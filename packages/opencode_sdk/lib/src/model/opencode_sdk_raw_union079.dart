...
class OpencodeSdkRawUnion079 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion079(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion079.fromJson(Object? json) =>
      OpencodeSdkRawUnion079(json);
