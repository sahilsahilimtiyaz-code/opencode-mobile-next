...
class LLMToolContent implements OpenCodeRawJsonValue {
  LLMToolContent(Object? value) : value = _copyJsonValue(value);

  factory LLMToolContent.fromJson(Object? json) => LLMToolContent(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"\$ref\":\"#/components/schemas/ToolTextContent\"},{\"\$ref\":\"#/components/schemas/ToolFileContent\"}]}";
