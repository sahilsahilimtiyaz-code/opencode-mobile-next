...
class OpencodeSdkRawUnion072 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion072(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion072.fromJson(Object? json) =>
      OpencodeSdkRawUnion072(json);
