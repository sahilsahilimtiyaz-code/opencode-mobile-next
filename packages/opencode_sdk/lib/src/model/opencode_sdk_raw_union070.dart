...
class OpencodeSdkRawUnion070 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion070(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion070.fromJson(Object? json) =>
      OpencodeSdkRawUnion070(json);
