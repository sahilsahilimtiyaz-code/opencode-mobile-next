...
part 'question_v2_replied.g.dart';
...
class QuestionV2Replied {
  /// Returns a new [QuestionV2Replied] instance.
  QuestionV2Replied({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: QuestionV2RepliedTypeEnum.unknownDefaultOpenApi,
  )
  final QuestionV2RepliedTypeEnum type;
  ...
  final QuestionV2RepliedData data;

  bool operator ==(Object other) {
    return identical(this, other) ||
        other is QuestionV2Replied &&
  ...
  factory QuestionV2Replied.fromJson(Map<String, dynamic> json) =>
      _$QuestionV2RepliedFromJson(json);

  Map<String, dynamic> toJson() => _$QuestionV2RepliedToJson(this);
