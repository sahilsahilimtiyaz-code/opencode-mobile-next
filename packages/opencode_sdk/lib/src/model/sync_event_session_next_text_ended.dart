...
part 'sync_event_session_next_text_ended.g.dart';
...
class SyncEventSessionNextTextEnded {
  /// Returns a new [SyncEventSessionNextTextEnded] instance.
  ...
  final SyncEventSessionNextTextEndedTypeEnum type;
  ...
  factory SyncEventSessionNextTextEnded.fromJson(Map<String, dynamic> json) =>
      _$SyncEventSessionNextTextEndedFromJson(json);

  Map<String, dynamic> toJson() => _$SyncEventSessionNextTextEndedToJson(this);
...
enum SyncEventSessionNextTextEndedTypeEnum {
  @JsonValue(r'sync')
  sync_(r'sync'),
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi(r'unknown_default_open_api');

  const SyncEventSessionNextTextEndedTypeEnum(this.value);
