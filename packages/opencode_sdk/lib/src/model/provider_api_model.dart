...
class ProviderApiModel implements OpenCodeRawJsonValue {
  ProviderApiModel(Object? value) : value = _copyJsonValue(value);

  factory ProviderApiModel.fromJson(Object? json) => ProviderApiModel(json);
