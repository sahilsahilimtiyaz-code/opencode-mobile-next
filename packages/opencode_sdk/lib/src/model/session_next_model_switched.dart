...
part 'session_next_model_switched.g.dart';
...
class SessionNextModelSwitched {
  /// Returns a new [SessionNextModelSwitched] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionNextModelSwitchedTypeEnum.unknownDefaultOpenApi,
  )
  final SessionNextModelSwitchedTypeEnum type;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is SessionNextModelSwitched &&
  ...
  factory SessionNextModelSwitched.fromJson(Map<String, dynamic> json) =>
      _$SessionNextModelSwitchedFromJson(json);

  Map<String, dynamic> toJson() => _$SessionNextModelSwitchedToJson(this);
...
enum SessionNextModelSwitchedTypeEnum {
  ...
  const SessionNextModelSwitchedTypeEnum(this.value);
