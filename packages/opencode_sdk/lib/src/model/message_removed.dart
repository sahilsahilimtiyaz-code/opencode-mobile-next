...
class MessageRemoved {
  /// Returns a new [MessageRemoved] instance.
  MessageRemoved({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: MessageRemovedTypeEnum.unknownDefaultOpenApi,
  )
  final MessageRemovedTypeEnum type;
  ...
  factory MessageRemoved.fromJson(Map<String, dynamic> json) =>
      _$MessageRemovedFromJson(json);

  Map<String, dynamic> toJson() => _$MessageRemovedToJson(this);
