...
class OpencodeSdkRawUnion043 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion043(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion043.fromJson(Object? json) =>
      OpencodeSdkRawUnion043(json);
