...
class WorktreeReady {
  /// Returns a new [WorktreeReady] instance.
  WorktreeReady({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: WorktreeReadyTypeEnum.unknownDefaultOpenApi,
  )
  final WorktreeReadyTypeEnum type;
  ...
  final WorktreeReadyData data;

  bool operator ==(Object other) {
    return identical(this, other) ||
        other is WorktreeReady &&
  ...
  factory WorktreeReady.fromJson(Map<String, dynamic> json) =>
      _$WorktreeReadyFromJson(json);

  Map<String, dynamic> toJson() => _$WorktreeReadyToJson(this);
