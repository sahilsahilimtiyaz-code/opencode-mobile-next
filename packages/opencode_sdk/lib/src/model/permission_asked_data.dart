...
part 'permission_asked_data.g.dart';
...
class PermissionAskedData {
  /// Returns a new [PermissionAskedData] instance.
  PermissionAskedData({
    required this.id,
  ...
  factory PermissionAskedData.fromJson(Map<String, dynamic> json) =>
      _$PermissionAskedDataFromJson(json);

  Map<String, dynamic> toJson() => _$PermissionAskedDataToJson(this);
