...
class QuestionV2Asked {
  /// Returns a new [QuestionV2Asked] instance.
  QuestionV2Asked({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: QuestionV2AskedTypeEnum.unknownDefaultOpenApi,
  )
  final QuestionV2AskedTypeEnum type;
  ...
  final QuestionV2AskedData data;

  bool operator ==(Object other) {
    return identical(this, other) ||
        other is QuestionV2Asked &&
  ...
  factory QuestionV2Asked.fromJson(Map<String, dynamic> json) =>
      _$QuestionV2AskedFromJson(json);

  Map<String, dynamic> toJson() => _$QuestionV2AskedToJson(this);
