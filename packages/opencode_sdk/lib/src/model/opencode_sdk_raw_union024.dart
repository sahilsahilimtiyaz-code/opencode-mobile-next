...
class OpencodeSdkRawUnion024 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion024(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion024.fromJson(Object? json) =>
      OpencodeSdkRawUnion024(json);
