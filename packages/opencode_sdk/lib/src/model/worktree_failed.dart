...
class WorktreeFailed {
  /// Returns a new [WorktreeFailed] instance.
  WorktreeFailed({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: WorktreeFailedTypeEnum.unknownDefaultOpenApi,
  )
  final WorktreeFailedTypeEnum type;
  ...
  factory WorktreeFailed.fromJson(Map<String, dynamic> json) =>
      _$WorktreeFailedFromJson(json);

  Map<String, dynamic> toJson() => _$WorktreeFailedToJson(this);
