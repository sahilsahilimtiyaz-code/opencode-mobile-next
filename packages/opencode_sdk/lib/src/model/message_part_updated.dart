...
part 'message_part_updated.g.dart';
...
class MessagePartUpdated {
  /// Returns a new [MessagePartUpdated] instance.
  MessagePartUpdated({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: MessagePartUpdatedTypeEnum.unknownDefaultOpenApi,
  )
  final MessagePartUpdatedTypeEnum type;
  ...
  factory MessagePartUpdated.fromJson(Map<String, dynamic> json) =>
      _$MessagePartUpdatedFromJson(json);

  Map<String, dynamic> toJson() => _$MessagePartUpdatedToJson(this);
