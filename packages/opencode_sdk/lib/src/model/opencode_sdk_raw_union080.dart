...
class OpencodeSdkRawUnion080 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion080(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion080.fromJson(Object? json) =>
      OpencodeSdkRawUnion080(json);
