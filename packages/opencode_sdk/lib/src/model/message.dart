...
class Message implements OpenCodeRawJsonValue {
  Message(Object? value) : value = _copyJsonValue(value);

  factory Message.fromJson(Object? json) => Message(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"\$ref\":\"#/components/schemas/UserMessage\"},{\"\$ref\":\"#/components/schemas/AssistantMessage\"}]}";
