...
class FilePartSource implements OpenCodeRawJsonValue {
  FilePartSource(Object? value) : value = _copyJsonValue(value);

  factory FilePartSource.fromJson(Object? json) => FilePartSource(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"\$ref\":\"#/components/schemas/FileSource\"},{\"\$ref\":\"#/components/schemas/SymbolSource\"},{\"\$ref\":\"#/components/schemas/ResourceSource\"}]}";
