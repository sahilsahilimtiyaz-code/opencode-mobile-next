...
part 'session_next_text_ended.g.dart';
...
class SessionNextTextEnded {
  /// Returns a new [SessionNextTextEnded] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionNextTextEndedTypeEnum.unknownDefaultOpenApi,
  )
  final SessionNextTextEndedTypeEnum type;
  ...
  factory SessionNextTextEnded.fromJson(Map<String, dynamic> json) =>
      _$SessionNextTextEndedFromJson(json);

  Map<String, dynamic> toJson() => _$SessionNextTextEndedToJson(this);
