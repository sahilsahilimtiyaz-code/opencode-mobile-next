...
class IntegrationMethod implements OpenCodeRawJsonValue {
  IntegrationMethod(Object? value) : value = _copyJsonValue(value);

  factory IntegrationMethod.fromJson(Object? json) => IntegrationMethod(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"\$ref\":\"#/components/schemas/IntegrationOAuthMethod\"},{\"\$ref\":\"#/components/schemas/IntegrationKeyMethod\"},{\"\$ref\":\"#/components/schemas/IntegrationEnvMethod\"}]}";
