...
class EventMessageUpdated {
  /// Returns a new [EventMessageUpdated] instance.
  EventMessageUpdated({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: EventMessageUpdatedTypeEnum.unknownDefaultOpenApi,
  )
  final EventMessageUpdatedTypeEnum type;
