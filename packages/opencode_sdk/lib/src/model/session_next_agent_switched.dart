...
part 'session_next_agent_switched.g.dart';
...
class SessionNextAgentSwitched {
  /// Returns a new [SessionNextAgentSwitched] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionNextAgentSwitchedTypeEnum.unknownDefaultOpenApi,
  )
  final SessionNextAgentSwitchedTypeEnum type;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is SessionNextAgentSwitched &&
  ...
  factory SessionNextAgentSwitched.fromJson(Map<String, dynamic> json) =>
      _$SessionNextAgentSwitchedFromJson(json);

  Map<String, dynamic> toJson() => _$SessionNextAgentSwitchedToJson(this);
...
enum SessionNextAgentSwitchedTypeEnum {
  ...
  const SessionNextAgentSwitchedTypeEnum(this.value);
