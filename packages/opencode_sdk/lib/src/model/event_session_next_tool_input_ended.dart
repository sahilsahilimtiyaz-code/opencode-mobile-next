...
part 'event_session_next_tool_input_ended.g.dart';
...
class EventSessionNextToolInputEnded {
  /// Returns a new [EventSessionNextToolInputEnded] instance.
  ...
  final EventSessionNextToolInputEndedTypeEnum type;
  ...
  factory EventSessionNextToolInputEnded.fromJson(Map<String, dynamic> json) =>
      _$EventSessionNextToolInputEndedFromJson(json);

  Map<String, dynamic> toJson() => _$EventSessionNextToolInputEndedToJson(this);
...
enum EventSessionNextToolInputEndedTypeEnum {
  ...
  const EventSessionNextToolInputEndedTypeEnum(this.value);
