...
part 'session_next_revert_committed.g.dart';
...
class SessionNextRevertCommitted {
  /// Returns a new [SessionNextRevertCommitted] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionNextRevertCommittedTypeEnum.unknownDefaultOpenApi,
  )
  final SessionNextRevertCommittedTypeEnum type;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is SessionNextRevertCommitted &&
  ...
  factory SessionNextRevertCommitted.fromJson(Map<String, dynamic> json) =>
      _$SessionNextRevertCommittedFromJson(json);

  Map<String, dynamic> toJson() => _$SessionNextRevertCommittedToJson(this);
...
enum SessionNextRevertCommittedTypeEnum {
  ...
  const SessionNextRevertCommittedTypeEnum(this.value);
