...
class Auth implements OpenCodeRawJsonValue {
  Auth(Object? value) : value = _copyJsonValue(value);

  factory Auth.fromJson(Object? json) => Auth(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"\$ref\":\"#/components/schemas/OAuth\"},{\"\$ref\":\"#/components/schemas/ApiAuth\"},{\"\$ref\":\"#/components/schemas/WellKnownAuth\"}]}";
