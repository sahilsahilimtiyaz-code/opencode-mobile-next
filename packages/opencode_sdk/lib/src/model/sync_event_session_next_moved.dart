...
part 'sync_event_session_next_moved.g.dart';
...
class SyncEventSessionNextMoved {
  /// Returns a new [SyncEventSessionNextMoved] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SyncEventSessionNextMovedTypeEnum.unknownDefaultOpenApi,
  )
  final SyncEventSessionNextMovedTypeEnum type;
  ...
  factory SyncEventSessionNextMoved.fromJson(Map<String, dynamic> json) =>
      _$SyncEventSessionNextMovedFromJson(json);

  Map<String, dynamic> toJson() => _$SyncEventSessionNextMovedToJson(this);
...
enum SyncEventSessionNextMovedTypeEnum {
  @JsonValue(r'sync')
  sync_(r'sync'),
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi(r'unknown_default_open_api');

  const SyncEventSessionNextMovedTypeEnum(this.value);
