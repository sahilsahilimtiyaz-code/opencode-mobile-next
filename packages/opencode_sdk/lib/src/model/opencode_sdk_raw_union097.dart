...
class OpencodeSdkRawUnion097 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion097(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion097.fromJson(Object? json) =>
      OpencodeSdkRawUnion097(json);
