...
class OpencodeSdkRawUnion083 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion083(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion083.fromJson(Object? json) =>
      OpencodeSdkRawUnion083(json);
