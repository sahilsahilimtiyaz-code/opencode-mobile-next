...
class OpencodeSdkRawUnion069 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion069(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion069.fromJson(Object? json) =>
      OpencodeSdkRawUnion069(json);
