...
class MCPStatus implements OpenCodeRawJsonValue {
  MCPStatus(Object? value) : value = _copyJsonValue(value);

  factory MCPStatus.fromJson(Object? json) => MCPStatus(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"\$ref\":\"#/components/schemas/MCPStatusConnected\"},{\"\$ref\":\"#/components/schemas/MCPStatusDisabled\"},{\"\$ref\":\"#/components/schemas/MCPStatusFailed\"},{\"\$ref\":\"#/components/schemas/MCPStatusNeedsAuth\"},{\"\$ref\":\"#/components/schemas/MCPStatusNeedsClientRegistration\"}]}";
