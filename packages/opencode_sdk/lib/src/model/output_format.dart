...
class OutputFormat implements OpenCodeRawJsonValue {
  OutputFormat(Object? value) : value = _copyJsonValue(value);

  factory OutputFormat.fromJson(Object? json) => OutputFormat(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"\$ref\":\"#/components/schemas/OutputFormatText\"},{\"\$ref\":\"#/components/schemas/OutputFormatJsonSchema\"}]}";
