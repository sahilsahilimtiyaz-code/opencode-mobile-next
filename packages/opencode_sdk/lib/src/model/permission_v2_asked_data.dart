...
part 'permission_v2_asked_data.g.dart';
...
class PermissionV2AskedData {
  /// Returns a new [PermissionV2AskedData] instance.
  PermissionV2AskedData({
    required this.id,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is PermissionV2AskedData &&
  ...
  factory PermissionV2AskedData.fromJson(Map<String, dynamic> json) =>
      _$PermissionV2AskedDataFromJson(json);

  Map<String, dynamic> toJson() => _$PermissionV2AskedDataToJson(this);
