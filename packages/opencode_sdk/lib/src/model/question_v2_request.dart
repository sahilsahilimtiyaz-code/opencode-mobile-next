...
part 'question_v2_request.g.dart';
...
class QuestionV2Request {
  /// Returns a new [QuestionV2Request] instance.
  QuestionV2Request({
    required this.id,
  ...
  factory QuestionV2Request.fromJson(Map<String, dynamic> json) =>
      _$QuestionV2RequestFromJson(json);

  Map<String, dynamic> toJson() => _$QuestionV2RequestToJson(this);
