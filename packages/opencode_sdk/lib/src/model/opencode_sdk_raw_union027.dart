...
class OpencodeSdkRawUnion027 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion027(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion027.fromJson(Object? json) =>
      OpencodeSdkRawUnion027(json);
