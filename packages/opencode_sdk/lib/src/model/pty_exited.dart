...
class PtyExited {
  /// Returns a new [PtyExited] instance.
  PtyExited({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: PtyExitedTypeEnum.unknownDefaultOpenApi,
  )
  final PtyExitedTypeEnum type;
  ...
  factory PtyExited.fromJson(Map<String, dynamic> json) =>
      _$PtyExitedFromJson(json);

  Map<String, dynamic> toJson() => _$PtyExitedToJson(this);
