...
part 'session_next_revert_cleared.g.dart';
...
class SessionNextRevertCleared {
  /// Returns a new [SessionNextRevertCleared] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionNextRevertClearedTypeEnum.unknownDefaultOpenApi,
  )
  final SessionNextRevertClearedTypeEnum type;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is SessionNextRevertCleared &&
  ...
  factory SessionNextRevertCleared.fromJson(Map<String, dynamic> json) =>
      _$SessionNextRevertClearedFromJson(json);

  Map<String, dynamic> toJson() => _$SessionNextRevertClearedToJson(this);
...
enum SessionNextRevertClearedTypeEnum {
  ...
  const SessionNextRevertClearedTypeEnum(this.value);
