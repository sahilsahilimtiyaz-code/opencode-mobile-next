...
part 'session_next_reasoning_ended.g.dart';
...
class SessionNextReasoningEnded {
  /// Returns a new [SessionNextReasoningEnded] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionNextReasoningEndedTypeEnum.unknownDefaultOpenApi,
  )
  final SessionNextReasoningEndedTypeEnum type;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is SessionNextReasoningEnded &&
  ...
  factory SessionNextReasoningEnded.fromJson(Map<String, dynamic> json) =>
      _$SessionNextReasoningEndedFromJson(json);

  Map<String, dynamic> toJson() => _$SessionNextReasoningEndedToJson(this);
...
enum SessionNextReasoningEndedTypeEnum {
  ...
  const SessionNextReasoningEndedTypeEnum(this.value);
