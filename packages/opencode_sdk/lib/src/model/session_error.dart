...
class SessionError {
  /// Returns a new [SessionError] instance.
  SessionError({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionErrorTypeEnum.unknownDefaultOpenApi,
  )
  final SessionErrorTypeEnum type;
