...
class WorkspaceFailed {
  /// Returns a new [WorkspaceFailed] instance.
  WorkspaceFailed({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: WorkspaceFailedTypeEnum.unknownDefaultOpenApi,
  )
  final WorkspaceFailedTypeEnum type;
  ...
  factory WorkspaceFailed.fromJson(Map<String, dynamic> json) =>
      _$WorkspaceFailedFromJson(json);

  Map<String, dynamic> toJson() => _$WorkspaceFailedToJson(this);
