...
class OpencodeSdkRawUnion095 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion095(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion095.fromJson(Object? json) =>
      OpencodeSdkRawUnion095(json);
