...
part 'session_next_text_delta.g.dart';
...
class SessionNextTextDelta {
  /// Returns a new [SessionNextTextDelta] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionNextTextDeltaTypeEnum.unknownDefaultOpenApi,
  )
  final SessionNextTextDeltaTypeEnum type;
  ...
  final SessionNextTextDeltaData data;

  bool operator ==(Object other) {
    return identical(this, other) ||
        other is SessionNextTextDelta &&
  ...
  factory SessionNextTextDelta.fromJson(Map<String, dynamic> json) =>
      _$SessionNextTextDeltaFromJson(json);

  Map<String, dynamic> toJson() => _$SessionNextTextDeltaToJson(this);
