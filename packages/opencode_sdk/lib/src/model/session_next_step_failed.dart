...
part 'session_next_step_failed.g.dart';
...
class SessionNextStepFailed {
  /// Returns a new [SessionNextStepFailed] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionNextStepFailedTypeEnum.unknownDefaultOpenApi,
  )
  final SessionNextStepFailedTypeEnum type;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is SessionNextStepFailed &&
  ...
  factory SessionNextStepFailed.fromJson(Map<String, dynamic> json) =>
      _$SessionNextStepFailedFromJson(json);

  Map<String, dynamic> toJson() => _$SessionNextStepFailedToJson(this);
