...
class OpencodeSdkRawUnion075 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion075(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion075.fromJson(Object? json) =>
      OpencodeSdkRawUnion075(json);
