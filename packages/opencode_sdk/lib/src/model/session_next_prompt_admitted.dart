...
part 'session_next_prompt_admitted.g.dart';
...
class SessionNextPromptAdmitted {
  /// Returns a new [SessionNextPromptAdmitted] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionNextPromptAdmittedTypeEnum.unknownDefaultOpenApi,
  )
  final SessionNextPromptAdmittedTypeEnum type;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is SessionNextPromptAdmitted &&
  ...
  factory SessionNextPromptAdmitted.fromJson(Map<String, dynamic> json) =>
      _$SessionNextPromptAdmittedFromJson(json);

  Map<String, dynamic> toJson() => _$SessionNextPromptAdmittedToJson(this);
...
enum SessionNextPromptAdmittedTypeEnum {
  ...
  const SessionNextPromptAdmittedTypeEnum(this.value);
