...
class ToolState implements OpenCodeRawJsonValue {
  ToolState(Object? value) : value = _copyJsonValue(value);

  factory ToolState.fromJson(Object? json) => ToolState(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"\$ref\":\"#/components/schemas/ToolStatePending\"},{\"\$ref\":\"#/components/schemas/ToolStateRunning\"},{\"\$ref\":\"#/components/schemas/ToolStateCompleted\"},{\"\$ref\":\"#/components/schemas/ToolStateError\"}]}";
