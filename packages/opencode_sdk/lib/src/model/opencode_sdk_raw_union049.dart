...
class OpencodeSdkRawUnion049 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion049(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion049.fromJson(Object? json) =>
      OpencodeSdkRawUnion049(json);
