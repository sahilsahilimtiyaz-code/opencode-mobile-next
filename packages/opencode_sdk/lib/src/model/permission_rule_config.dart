...
class PermissionRuleConfig implements OpenCodeRawJsonValue {
  PermissionRuleConfig(Object? value) : value = _copyJsonValue(value);

  factory PermissionRuleConfig.fromJson(Object? json) =>
      PermissionRuleConfig(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"\$ref\":\"#/components/schemas/PermissionActionConfig\"},{\"\$ref\":\"#/components/schemas/PermissionObjectConfig\"}]}";
