...
class OpencodeSdkRawUnion060 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion060(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion060.fromJson(Object? json) =>
      OpencodeSdkRawUnion060(json);
