...
part 'sync_event_session_updated_sync_event.g.dart';
...
class SyncEventSessionUpdatedSyncEvent {
  /// Returns a new [SyncEventSessionUpdatedSyncEvent] instance.
  ...
  final SyncEventSessionUpdatedSyncEventTypeEnum type;
  ...
  factory SyncEventSessionUpdatedSyncEvent.fromJson(
    Map<String, dynamic> json,
  ) => _$SyncEventSessionUpdatedSyncEventFromJson(json);

  Map<String, dynamic> toJson() =>
      _$SyncEventSessionUpdatedSyncEventToJson(this);
...
enum SyncEventSessionUpdatedSyncEventTypeEnum {
  @JsonValue(r'session.updated.1')
  sessionPeriodUpdatedPeriod1(r'session.updated.1'),
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi(r'unknown_default_open_api');

  const SyncEventSessionUpdatedSyncEventTypeEnum(this.value);
