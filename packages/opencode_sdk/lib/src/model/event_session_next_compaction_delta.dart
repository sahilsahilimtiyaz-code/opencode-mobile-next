...
part 'event_session_next_compaction_delta.g.dart';
...
class EventSessionNextCompactionDelta {
  /// Returns a new [EventSessionNextCompactionDelta] instance.
  ...
  final EventSessionNextCompactionDeltaTypeEnum type;
  ...
  factory EventSessionNextCompactionDelta.fromJson(Map<String, dynamic> json) =>
      _$EventSessionNextCompactionDeltaFromJson(json);

  Map<String, dynamic> toJson() =>
      _$EventSessionNextCompactionDeltaToJson(this);
...
enum EventSessionNextCompactionDeltaTypeEnum {
  ...
  const EventSessionNextCompactionDeltaTypeEnum(this.value);
