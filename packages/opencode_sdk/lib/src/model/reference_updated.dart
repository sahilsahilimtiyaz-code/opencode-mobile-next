...
class ReferenceUpdated {
  /// Returns a new [ReferenceUpdated] instance.
  ReferenceUpdated({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: ReferenceUpdatedTypeEnum.unknownDefaultOpenApi,
  )
  final ReferenceUpdatedTypeEnum type;
  ...
  factory ReferenceUpdated.fromJson(Map<String, dynamic> json) =>
      _$ReferenceUpdatedFromJson(json);

  Map<String, dynamic> toJson() => _$ReferenceUpdatedToJson(this);
