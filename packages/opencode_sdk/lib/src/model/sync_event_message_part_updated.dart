...
part 'sync_event_message_part_updated.g.dart';
...
class SyncEventMessagePartUpdated {
  /// Returns a new [SyncEventMessagePartUpdated] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SyncEventMessagePartUpdatedTypeEnum.unknownDefaultOpenApi,
  )
  final SyncEventMessagePartUpdatedTypeEnum type;
  ...
  factory SyncEventMessagePartUpdated.fromJson(Map<String, dynamic> json) =>
      _$SyncEventMessagePartUpdatedFromJson(json);

  Map<String, dynamic> toJson() => _$SyncEventMessagePartUpdatedToJson(this);
...
enum SyncEventMessagePartUpdatedTypeEnum {
  @JsonValue(r'sync')
  sync_(r'sync'),
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi(r'unknown_default_open_api');

  const SyncEventMessagePartUpdatedTypeEnum(this.value);
