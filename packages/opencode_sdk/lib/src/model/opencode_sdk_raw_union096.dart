...
class OpencodeSdkRawUnion096 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion096(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion096.fromJson(Object? json) =>
      OpencodeSdkRawUnion096(json);
