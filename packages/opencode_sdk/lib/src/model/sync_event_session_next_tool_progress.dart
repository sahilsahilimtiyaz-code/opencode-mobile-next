...
part 'sync_event_session_next_tool_progress.g.dart';
...
class SyncEventSessionNextToolProgress {
  /// Returns a new [SyncEventSessionNextToolProgress] instance.
  ...
  final SyncEventSessionNextToolProgressTypeEnum type;
  ...
  factory SyncEventSessionNextToolProgress.fromJson(
    Map<String, dynamic> json,
  ) => _$SyncEventSessionNextToolProgressFromJson(json);

  Map<String, dynamic> toJson() =>
      _$SyncEventSessionNextToolProgressToJson(this);
...
enum SyncEventSessionNextToolProgressTypeEnum {
  @JsonValue(r'sync')
  sync_(r'sync'),
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi(r'unknown_default_open_api');

  const SyncEventSessionNextToolProgressTypeEnum(this.value);
