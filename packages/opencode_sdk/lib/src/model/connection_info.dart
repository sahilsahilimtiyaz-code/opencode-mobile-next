...
class ConnectionInfo implements OpenCodeRawJsonValue {
  ConnectionInfo(Object? value) : value = _copyJsonValue(value);

  factory ConnectionInfo.fromJson(Object? json) => ConnectionInfo(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"\$ref\":\"#/components/schemas/ConnectionCredentialInfo\"},{\"\$ref\":\"#/components/schemas/ConnectionEnvInfo\"}]}";
