...
part 'session_next_moved.g.dart';
...
class SessionNextMoved {
  /// Returns a new [SessionNextMoved] instance.
  SessionNextMoved({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionNextMovedTypeEnum.unknownDefaultOpenApi,
  )
  final SessionNextMovedTypeEnum type;
  ...
  factory SessionNextMoved.fromJson(Map<String, dynamic> json) =>
      _$SessionNextMovedFromJson(json);

  Map<String, dynamic> toJson() => _$SessionNextMovedToJson(this);
