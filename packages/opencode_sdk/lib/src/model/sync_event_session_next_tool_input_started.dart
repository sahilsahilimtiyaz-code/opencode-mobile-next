...
part 'sync_event_session_next_tool_input_started.g.dart';
...
class SyncEventSessionNextToolInputStarted {
  /// Returns a new [SyncEventSessionNextToolInputStarted] instance.
  ...
  final SyncEventSessionNextToolInputStartedTypeEnum type;
  ...
  factory SyncEventSessionNextToolInputStarted.fromJson(
    Map<String, dynamic> json,
  ) => _$SyncEventSessionNextToolInputStartedFromJson(json);

  Map<String, dynamic> toJson() =>
      _$SyncEventSessionNextToolInputStartedToJson(this);
...
enum SyncEventSessionNextToolInputStartedTypeEnum {
  @JsonValue(r'sync')
  sync_(r'sync'),
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi(r'unknown_default_open_api');

  const SyncEventSessionNextToolInputStartedTypeEnum(this.value);
