...
class PtyUpdated {
  /// Returns a new [PtyUpdated] instance.
  PtyUpdated({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: PtyUpdatedTypeEnum.unknownDefaultOpenApi,
  )
  final PtyUpdatedTypeEnum type;
  ...
  factory PtyUpdated.fromJson(Map<String, dynamic> json) =>
      _$PtyUpdatedFromJson(json);

  Map<String, dynamic> toJson() => _$PtyUpdatedToJson(this);
