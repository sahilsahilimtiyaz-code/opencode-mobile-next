...
class AgentColor implements OpenCodeRawJsonValue {
  AgentColor(Object? value) : value = _copyJsonValue(value);

  factory AgentColor.fromJson(Object? json) => AgentColor(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"type\":\"string\",\"pattern\":\"^#[0-9a-fA-F]{6}\$\"},{\"type\":\"string\",\"enum\":[\"primary\",\"secondary\",\"accent\",\"success\",\"warning\",\"error\",\"info\"]}]}";
