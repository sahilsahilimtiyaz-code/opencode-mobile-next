...
part 'event_session_next_tool_called.g.dart';
...
class EventSessionNextToolCalled {
  /// Returns a new [EventSessionNextToolCalled] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: EventSessionNextToolCalledTypeEnum.unknownDefaultOpenApi,
  )
  final EventSessionNextToolCalledTypeEnum type;
  ...
  factory EventSessionNextToolCalled.fromJson(Map<String, dynamic> json) =>
      _$EventSessionNextToolCalledFromJson(json);

  Map<String, dynamic> toJson() => _$EventSessionNextToolCalledToJson(this);
