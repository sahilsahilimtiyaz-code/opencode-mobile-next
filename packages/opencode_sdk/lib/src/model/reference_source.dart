...
class ReferenceSource implements OpenCodeRawJsonValue {
  ReferenceSource(Object? value) : value = _copyJsonValue(value);

  factory ReferenceSource.fromJson(Object? json) => ReferenceSource(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"\$ref\":\"#/components/schemas/ReferenceLocalSource\"},{\"\$ref\":\"#/components/schemas/ReferenceGitSource\"}]}";
