...
class ServerConnected {
  /// Returns a new [ServerConnected] instance.
  ServerConnected({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: ServerConnectedTypeEnum.unknownDefaultOpenApi,
  )
  final ServerConnectedTypeEnum type;
  ...
  factory ServerConnected.fromJson(Map<String, dynamic> json) =>
      _$ServerConnectedFromJson(json);

  Map<String, dynamic> toJson() => _$ServerConnectedToJson(this);
