...
part 'session_next_tool_success.g.dart';
...
class SessionNextToolSuccess {
  /// Returns a new [SessionNextToolSuccess] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionNextToolSuccessTypeEnum.unknownDefaultOpenApi,
  )
  final SessionNextToolSuccessTypeEnum type;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is SessionNextToolSuccess &&
  ...
  factory SessionNextToolSuccess.fromJson(Map<String, dynamic> json) =>
      _$SessionNextToolSuccessFromJson(json);

  Map<String, dynamic> toJson() => _$SessionNextToolSuccessToJson(this);
...
enum SessionNextToolSuccessTypeEnum {
  ...
  const SessionNextToolSuccessTypeEnum(this.value);
