...
part 'event_session_next_context_updated.g.dart';
...
class EventSessionNextContextUpdated {
  /// Returns a new [EventSessionNextContextUpdated] instance.
  ...
  final EventSessionNextContextUpdatedTypeEnum type;
  ...
  factory EventSessionNextContextUpdated.fromJson(Map<String, dynamic> json) =>
      _$EventSessionNextContextUpdatedFromJson(json);

  Map<String, dynamic> toJson() => _$EventSessionNextContextUpdatedToJson(this);
...
enum EventSessionNextContextUpdatedTypeEnum {
  ...
  const EventSessionNextContextUpdatedTypeEnum(this.value);
