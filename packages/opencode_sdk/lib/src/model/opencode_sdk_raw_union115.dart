...
class OpencodeSdkRawUnion115 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion115(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion115.fromJson(Object? json) =>
      OpencodeSdkRawUnion115(json);
