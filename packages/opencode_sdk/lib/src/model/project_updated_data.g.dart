...
part of 'project_updated_data.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ProjectUpdatedData _$ProjectUpdatedDataFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('ProjectUpdatedData', json, ($checkedConvert) {
  $checkKeys(json, requiredKeys: const ['id', 'worktree', 'time', 'sandboxes']);
  final val = ProjectUpdatedData(
...
Map<String, dynamic> _$ProjectUpdatedDataToJson(ProjectUpdatedData instance) =>
    <String, dynamic>{
      'id': instance.id,
