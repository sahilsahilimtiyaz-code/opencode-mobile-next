...
class SessionUpdated {
  /// Returns a new [SessionUpdated] instance.
  SessionUpdated({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionUpdatedTypeEnum.unknownDefaultOpenApi,
  )
  final SessionUpdatedTypeEnum type;
  ...
  factory SessionUpdated.fromJson(Map<String, dynamic> json) =>
      _$SessionUpdatedFromJson(json);

  Map<String, dynamic> toJson() => _$SessionUpdatedToJson(this);
