...
class OpencodeSdkRawUnion004 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion004(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion004.fromJson(Object? json) =>
      OpencodeSdkRawUnion004(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"type\":\"integer\",\"exclusiveMinimum\":0},{\"type\":\"boolean\",\"enum\":[false]}],\"description\":\"Timeout in milliseconds for full requests to this provider. Set to false to disable timeout.\"}";
