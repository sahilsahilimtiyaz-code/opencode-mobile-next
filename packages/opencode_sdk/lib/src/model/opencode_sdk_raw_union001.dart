...
class OpencodeSdkRawUnion001 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion001(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion001.fromJson(Object? json) =>
      OpencodeSdkRawUnion001(json);
