...
class SessionMessage implements OpenCodeRawJsonValue {
  SessionMessage(Object? value) : value = _copyJsonValue(value);

  factory SessionMessage.fromJson(Object? json) => SessionMessage(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"\$ref\":\"#/components/schemas/SessionMessageAgentSwitched\"},{\"\$ref\":\"#/components/schemas/SessionMessageModelSwitched\"},{\"\$ref\":\"#/components/schemas/SessionMessageUser\"},{\"\$ref\":\"#/components/schemas/SessionMessageSynthetic\"},{\"\$ref\":\"#/components/schemas/SessionMessageSystem\"},{\"\$ref\":\"#/components/schemas/SessionMessageShell\"},{\"\$ref\":\"#/components/schemas/SessionMessageAssistant\"},{\"\$ref\":\"#/components/schemas/SessionMessageCompaction\"}]}";
