...
class CredentialValue implements OpenCodeRawJsonValue {
  CredentialValue(Object? value) : value = _copyJsonValue(value);

  factory CredentialValue.fromJson(Object? json) => CredentialValue(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"\$ref\":\"#/components/schemas/CredentialOAuth\"},{\"\$ref\":\"#/components/schemas/CredentialKey\"}]}";
