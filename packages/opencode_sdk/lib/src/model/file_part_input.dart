...
class FilePartInput {
  /// Returns a new [FilePartInput] instance.
  FilePartInput({
    this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: FilePartInputTypeEnum.unknownDefaultOpenApi,
  )
  final FilePartInputTypeEnum type;
...
enum FilePartInputTypeEnum {
  @JsonValue(r'file')
  file(r'file'),
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi(r'unknown_default_open_api');

  const FilePartInputTypeEnum(this.value);
