...
part 'sync_event_session_updated.g.dart';
...
class SyncEventSessionUpdated {
  /// Returns a new [SyncEventSessionUpdated] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SyncEventSessionUpdatedTypeEnum.unknownDefaultOpenApi,
  )
  final SyncEventSessionUpdatedTypeEnum type;
  ...
  factory SyncEventSessionUpdated.fromJson(Map<String, dynamic> json) =>
      _$SyncEventSessionUpdatedFromJson(json);

  Map<String, dynamic> toJson() => _$SyncEventSessionUpdatedToJson(this);
...
enum SyncEventSessionUpdatedTypeEnum {
  @JsonValue(r'sync')
  sync_(r'sync'),
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi(r'unknown_default_open_api');

  const SyncEventSessionUpdatedTypeEnum(this.value);
