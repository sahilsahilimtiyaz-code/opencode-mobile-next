...
part 'sync_event_session_next_shell_ended.g.dart';
...
class SyncEventSessionNextShellEnded {
  /// Returns a new [SyncEventSessionNextShellEnded] instance.
  ...
  final SyncEventSessionNextShellEndedTypeEnum type;
  ...
  factory SyncEventSessionNextShellEnded.fromJson(Map<String, dynamic> json) =>
      _$SyncEventSessionNextShellEndedFromJson(json);

  Map<String, dynamic> toJson() => _$SyncEventSessionNextShellEndedToJson(this);
...
enum SyncEventSessionNextShellEndedTypeEnum {
  @JsonValue(r'sync')
  sync_(r'sync'),
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi(r'unknown_default_open_api');

  const SyncEventSessionNextShellEndedTypeEnum(this.value);
