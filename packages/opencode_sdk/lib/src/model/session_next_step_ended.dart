...
part 'session_next_step_ended.g.dart';
...
class SessionNextStepEnded {
  /// Returns a new [SessionNextStepEnded] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionNextStepEndedTypeEnum.unknownDefaultOpenApi,
  )
  final SessionNextStepEndedTypeEnum type;
  ...
  factory SessionNextStepEnded.fromJson(Map<String, dynamic> json) =>
      _$SessionNextStepEndedFromJson(json);

  Map<String, dynamic> toJson() => _$SessionNextStepEndedToJson(this);
