...
part 'session_next_compaction_started.g.dart';
...
class SessionNextCompactionStarted {
  /// Returns a new [SessionNextCompactionStarted] instance.
  ...
  final SessionNextCompactionStartedTypeEnum type;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is SessionNextCompactionStarted &&
  ...
  factory SessionNextCompactionStarted.fromJson(Map<String, dynamic> json) =>
      _$SessionNextCompactionStartedFromJson(json);

  Map<String, dynamic> toJson() => _$SessionNextCompactionStartedToJson(this);
...
enum SessionNextCompactionStartedTypeEnum {
  ...
  const SessionNextCompactionStartedTypeEnum(this.value);
