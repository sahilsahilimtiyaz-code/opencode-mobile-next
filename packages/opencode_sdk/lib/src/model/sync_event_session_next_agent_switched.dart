...
part 'sync_event_session_next_agent_switched.g.dart';
...
class SyncEventSessionNextAgentSwitched {
  /// Returns a new [SyncEventSessionNextAgentSwitched] instance.
  ...
  final SyncEventSessionNextAgentSwitchedTypeEnum type;
  ...
  factory SyncEventSessionNextAgentSwitched.fromJson(
    Map<String, dynamic> json,
  ) => _$SyncEventSessionNextAgentSwitchedFromJson(json);

  Map<String, dynamic> toJson() =>
      _$SyncEventSessionNextAgentSwitchedToJson(this);
...
enum SyncEventSessionNextAgentSwitchedTypeEnum {
  @JsonValue(r'sync')
  sync_(r'sync'),
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi(r'unknown_default_open_api');

  const SyncEventSessionNextAgentSwitchedTypeEnum(this.value);
