...
class SessionCreated {
  /// Returns a new [SessionCreated] instance.
  SessionCreated({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionCreatedTypeEnum.unknownDefaultOpenApi,
  )
  final SessionCreatedTypeEnum type;
  ...
  factory SessionCreated.fromJson(Map<String, dynamic> json) =>
      _$SessionCreatedFromJson(json);

  Map<String, dynamic> toJson() => _$SessionCreatedToJson(this);
