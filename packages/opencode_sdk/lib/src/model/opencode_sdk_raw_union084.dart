...
class OpencodeSdkRawUnion084 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion084(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion084.fromJson(Object? json) =>
      OpencodeSdkRawUnion084(json);
