...
part 'sync_event_session_next_step_ended.g.dart';
...
class SyncEventSessionNextStepEnded {
  /// Returns a new [SyncEventSessionNextStepEnded] instance.
  ...
  final SyncEventSessionNextStepEndedTypeEnum type;
  ...
  factory SyncEventSessionNextStepEnded.fromJson(Map<String, dynamic> json) =>
      _$SyncEventSessionNextStepEndedFromJson(json);

  Map<String, dynamic> toJson() => _$SyncEventSessionNextStepEndedToJson(this);
...
enum SyncEventSessionNextStepEndedTypeEnum {
  @JsonValue(r'sync')
  sync_(r'sync'),
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi(r'unknown_default_open_api');

  const SyncEventSessionNextStepEndedTypeEnum(this.value);
