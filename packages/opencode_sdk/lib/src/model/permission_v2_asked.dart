...
part 'permission_v2_asked.g.dart';
...
class PermissionV2Asked {
  /// Returns a new [PermissionV2Asked] instance.
  PermissionV2Asked({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: PermissionV2AskedTypeEnum.unknownDefaultOpenApi,
  )
  final PermissionV2AskedTypeEnum type;
  ...
  final PermissionV2AskedData data;

  bool operator ==(Object other) {
    return identical(this, other) ||
        other is PermissionV2Asked &&
  ...
  factory PermissionV2Asked.fromJson(Map<String, dynamic> json) =>
      _$PermissionV2AskedFromJson(json);

  Map<String, dynamic> toJson() => _$PermissionV2AskedToJson(this);
