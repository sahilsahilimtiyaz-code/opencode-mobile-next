...
class OpencodeSdkRawUnion073 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion073(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion073.fromJson(Object? json) =>
      OpencodeSdkRawUnion073(json);
