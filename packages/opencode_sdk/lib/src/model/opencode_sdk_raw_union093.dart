...
class OpencodeSdkRawUnion093 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion093(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion093.fromJson(Object? json) =>
      OpencodeSdkRawUnion093(json);
