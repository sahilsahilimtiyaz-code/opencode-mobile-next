...
part 'session_next_tool_input_ended.g.dart';
...
class SessionNextToolInputEnded {
  /// Returns a new [SessionNextToolInputEnded] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionNextToolInputEndedTypeEnum.unknownDefaultOpenApi,
  )
  final SessionNextToolInputEndedTypeEnum type;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is SessionNextToolInputEnded &&
  ...
  factory SessionNextToolInputEnded.fromJson(Map<String, dynamic> json) =>
      _$SessionNextToolInputEndedFromJson(json);

  Map<String, dynamic> toJson() => _$SessionNextToolInputEndedToJson(this);
...
enum SessionNextToolInputEndedTypeEnum {
  ...
  const SessionNextToolInputEndedTypeEnum(this.value);
