...
class LspUpdated {
  /// Returns a new [LspUpdated] instance.
  LspUpdated({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: LspUpdatedTypeEnum.unknownDefaultOpenApi,
  )
  final LspUpdatedTypeEnum type;
  ...
  factory LspUpdated.fromJson(Map<String, dynamic> json) =>
      _$LspUpdatedFromJson(json);

  Map<String, dynamic> toJson() => _$LspUpdatedToJson(this);
