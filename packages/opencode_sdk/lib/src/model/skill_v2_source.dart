...
class SkillV2Source implements OpenCodeRawJsonValue {
  SkillV2Source(Object? value) : value = _copyJsonValue(value);

  factory SkillV2Source.fromJson(Object? json) => SkillV2Source(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"\$ref\":\"#/components/schemas/SkillV2DirectorySource\"},{\"\$ref\":\"#/components/schemas/SkillV2UrlSource\"},{\"\$ref\":\"#/components/schemas/SkillV2EmbeddedSource\"}]}";
