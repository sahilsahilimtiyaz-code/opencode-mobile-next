...
class OpencodeSdkRawUnion045 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion045(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion045.fromJson(Object? json) =>
      OpencodeSdkRawUnion045(json);
