...
class FileEdited {
  /// Returns a new [FileEdited] instance.
  FileEdited({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: FileEditedTypeEnum.unknownDefaultOpenApi,
  )
  final FileEditedTypeEnum type;
  ...
  factory FileEdited.fromJson(Map<String, dynamic> json) =>
      _$FileEditedFromJson(json);

  Map<String, dynamic> toJson() => _$FileEditedToJson(this);
