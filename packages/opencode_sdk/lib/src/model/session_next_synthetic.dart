...
part 'session_next_synthetic.g.dart';
...
class SessionNextSynthetic {
  /// Returns a new [SessionNextSynthetic] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionNextSyntheticTypeEnum.unknownDefaultOpenApi,
  )
  final SessionNextSyntheticTypeEnum type;
  ...
  factory SessionNextSynthetic.fromJson(Map<String, dynamic> json) =>
      _$SessionNextSyntheticFromJson(json);

  Map<String, dynamic> toJson() => _$SessionNextSyntheticToJson(this);
