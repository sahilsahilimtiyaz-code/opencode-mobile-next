...
class SessionCompacted {
  /// Returns a new [SessionCompacted] instance.
  SessionCompacted({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SessionCompactedTypeEnum.unknownDefaultOpenApi,
  )
  final SessionCompactedTypeEnum type;
  ...
  factory SessionCompacted.fromJson(Map<String, dynamic> json) =>
      _$SessionCompactedFromJson(json);

  Map<String, dynamic> toJson() => _$SessionCompactedToJson(this);
