...
class ModelsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V2ModelList200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<V2ModelList200Response>> v2ModelList({
    ...
    const _operationId = r'v2.model.list';
    final _path = r'/api/model';
    ...
    V2ModelList200Response? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<V2ModelList200Response, V2ModelList200Response>(
              rawData,
    ...
    return Response<V2ModelList200Response>(
      data: _responseData,
