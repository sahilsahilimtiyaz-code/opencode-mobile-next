...
class CommandsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V2CommandList200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<V2CommandList200Response>> v2CommandList({
    ...
    const _operationId = r'v2.command.list';
    final _path = r'/api/command';
    ...
    V2CommandList200Response? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<V2CommandList200Response, V2CommandList200Response>(
              rawData,
    ...
    return Response<V2CommandList200Response>(
      data: _responseData,
