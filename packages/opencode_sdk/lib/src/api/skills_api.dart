...
class SkillsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V2SkillList200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<V2SkillList200Response>> v2SkillList({
    ...
    const _operationId = r'v2.skill.list';
    final _path = r'/api/skill';
    ...
    V2SkillList200Response? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<V2SkillList200Response, V2SkillList200Response>(
              rawData,
    ...
    return Response<V2SkillList200Response>(
      data: _responseData,
