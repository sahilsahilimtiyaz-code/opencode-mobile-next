...
class EventsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V2Event] as data
  /// Throws [DioException] if API call or serialization fails
  @Deprecated('Use OpencodeSdk.v2EventSubscribeStream() for this SSE endpoint.')
  Future<Response<V2Event>> v2EventSubscribe({
    ...
    const _operationId = r'v2.event.subscribe';
    ...
    V2Event? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<V2Event, V2Event>(rawData, 'V2Event', growable: true);
